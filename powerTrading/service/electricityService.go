...
func (t *ServiceSetup) QueryAssetMatchRecords(userId string, assetId string) ([]byte, error) {
	req := channel.Request{ChaincodeID: t.ChaincodeID, Fcn: "queryAssetMatchRecords", Args: [][]byte{[]byte(userId), []byte(assetId)}}
	response, err := t.Client.Query(req)
	if err != nil {
		return []byte{0x00}, err
	}
...
func (t *ServiceSetup) SaveAssetTransactionRecords(transaction SingleTransaction) (string, error) {
	eventID := "eventSaveAssetTransactionRecords"
	reg, notifier := regitserEvent(t.Client, t.ChaincodeID, eventID)
	defer t.Client.UnregisterChaincodeEvent(reg)
	// 将edu对象序列化成为字节数组
	b, err := json.Marshal(transaction)
	if err != nil {
		return "", fmt.Errorf("指定的transaction对象序列化时发生错误")
	}
	req := channel.Request{ChaincodeID: t.ChaincodeID, Fcn: "saveAssetTransactionRecords", Args: [][]byte{b, []byte(eventID)}}
	response, err := t.Client.Execute(req)
	if err != nil {
		return "", err
	}
...
func (t *ServiceSetup) QuerySingleAssetTransactionRecords(assetId string, date string) ([]byte, error) {
	req := channel.Request{ChaincodeID: t.ChaincodeID, Fcn: "querySingleAssetTransactionRecords", Args: [][]byte{[]byte(assetId), []byte(date)}}
	response, err := t.Client.Query(req)
	if err != nil {
		return []byte{0x00}, err
	}
...
func (t *ServiceSetup) QueryAssetTransactionRecords(assetId string) ([]byte, error) {
	req := channel.Request{ChaincodeID: t.ChaincodeID, Fcn: "queryAssetTransactionRecords", Args: [][]byte{[]byte(assetId)}}
	response, err := t.Client.Query(req)
	if err != nil {
		return []byte{0x00}, err
	}
...
func (t *ServiceSetup) QueryAllAssetsTransactionRecords() ([]byte, error) {
	req := channel.Request{ChaincodeID: t.ChaincodeID, Fcn: "queryAllAssetsTransactionRecords", Args: [][]byte{}}
	response, err := t.Client.Query(req)
	if err != nil {
		return []byte{0x00}, err
	}
...
func (t *ServiceSetup) QueryAllUsers() ([]byte, error) {
	req := channel.Request{ChaincodeID: t.ChaincodeID, Fcn: "queryAllUsers", Args: [][]byte{}}
	response, err := t.Client.Query(req)
	if err != nil {
		return []byte{0x00}, err
	}
...
func (t *ServiceSetup) DeleteOrderMatchRecords(asset Electricity) (string, error) {
	eventID := "eventDeleteOrderMatchRecords"
	reg, notifier := regitserEvent(t.Client, t.ChaincodeID, eventID)
	defer t.Client.UnregisterChaincodeEvent(reg)
	b, err := json.Marshal(asset)
	if err != nil {
	...
	req := channel.Request{ChaincodeID: t.ChaincodeID, Fcn: "deleteOrderMatchRecords", Args: [][]byte{b, []byte(eventID)}}
	response, err := t.Client.Execute(req)
	if err != nil {
		return "", err
	}
...
func (t *ServiceSetup) DeleteAssetMatchRecords(order Electricity) (string, error) {
	eventID := "eventDeleteAssetMatchRecords"
	reg, notifier := regitserEvent(t.Client, t.ChaincodeID, eventID)
	defer t.Client.UnregisterChaincodeEvent(reg)
	b, err := json.Marshal(order)
	if err != nil {
	...
	req := channel.Request{ChaincodeID: t.ChaincodeID, Fcn: "deleteAssetMatchRecords", Args: [][]byte{b, []byte(eventID)}}
	response, err := t.Client.Execute(req)
	if err != nil {
		return "", err
	}
...
func (t *ServiceSetup) UpdateOrderState(order Electricity) (string, error) {
	eventID := "eventUpdateOrderState"
	reg, notifier := regitserEvent(t.Client, t.ChaincodeID, eventID)
	defer t.Client.UnregisterChaincodeEvent(reg)
	b, err := json.Marshal(order)
	if err != nil {
	...
	req := channel.Request{ChaincodeID: t.ChaincodeID, Fcn: "updateOrderState", Args: [][]byte{b, []byte(eventID)}}
	response, err := t.Client.Execute(req)
	if err != nil {
		return "", err
	}
